...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-PolyPlay_MiSTer.git"
CORE_NAME=(Arcade-PolyPlay)
...
UPSTREAM_CORE_NAME=(Arcade-PolyPlay)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-PolyPlay.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-PolyPlay.rbf)
